...
public class ZombieVillagerEntityMixin extends HostileEntity {
    // Allows Rotten Berries to be fed to a Zombie Villager to decrease their speed
    public ZombieVillagerEntityMixin(EntityType<? extends HuskEntity> entityType, World world) {

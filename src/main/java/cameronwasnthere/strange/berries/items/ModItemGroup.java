...
public class ModItemGroup {
    public static final RegistryKey<ItemGroup> ITEM_GROUP = RegistryKey.of(RegistryKeys.ITEM_GROUP, Identifier.of(StrangeBerries.MOD_ID, "strange_berries_item_group"));

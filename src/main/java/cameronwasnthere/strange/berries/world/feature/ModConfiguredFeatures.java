...
import cameronwasnthere.strange.berries.block.*;
...
public class ModConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<RandomPatchFeatureConfig, ?>> DOLPHIN_BERRY_BUSH =
            ConfiguredFeatures.register("dolphin_berry_bush", Feature.RANDOM_PATCH,
                    ConfiguredFeatures.createRandomPatchFeatureConfig(6, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK,
                            new SimpleBlockFeatureConfig(BlockStateProvider.of(ModBlocks.DOLPHIN_BERRY_BUSH.getDefaultState().with(DolphinBerryBush.AGE, 3))))));

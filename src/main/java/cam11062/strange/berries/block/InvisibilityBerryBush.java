...
public class InvisibilityBerryBush extends SweetBerryBushBlock {
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(StrangeBerries.INVISIBILITY_BERRIES);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!bl && player.getStackInHand(hand).isOf(Items.BONE_MEAL)) {
            ...
            dropStack(world, pos, new ItemStack(StrangeBerries.INVISIBILITY_BERRIES, amount + (bl ? 1 : 0)));
        ...
        if (entity instanceof LivingEntity && entity.getType() != EntityType.FOX && entity.getType() != EntityType.BEE) {
            ...
            if (!(world.isClient || state.get(AGE) <= 0 || entity.lastRenderX == entity.getX() && entity.lastRenderZ == entity.getZ())) {
                ...
                if (d >= (double) 0.003f || e >= (double) 0.003f) {
                    ...
                    if (state.get(AGE) > 2) {
                        ((LivingEntity) entity).addStatusEffect(new StatusEffectInstance(StatusEffects.INVISIBILITY, 40, 0));
                    }
                }
            }
        }

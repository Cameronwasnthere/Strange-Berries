...
public class SeaBerryBush extends SweetBerryBushBlock {
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(StrangeBerries.SEA_BERRIES);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!bl && player.getStackInHand(hand).isOf(Items.BONE_MEAL)) {
            ...
            dropStack(world, pos, new ItemStack(StrangeBerries.SEA_BERRIES, amount + (bl ? 1 : 0)));
    ...
    public boolean canPlantOnTop(BlockState floor, BlockView world, BlockPos pos) {
        return floor.isOf(Blocks.STONE) || floor.isOf(Blocks.GRAVEL) || floor.isOf(Blocks.CLAY) || floor.isOf(Blocks.DIRT) || floor.isOf(Blocks.SAND);
    }

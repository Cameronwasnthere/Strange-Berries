...
public class NightBerryBush extends SweetBerryBushBlock {
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(StrangeBerries.NIGHT_BERRIES);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!bl && player.getStackInHand(hand).isOf(Items.BONE_MEAL)) {
            ...
            if ((time >= 13000 && (time < 22000))) {
                ...
                dropStack(world, pos, new ItemStack(StrangeBerries.NIGHT_BERRIES, amount + (bl ? 1 : 0)));
    ...
    public NightBerryBush(AbstractBlock.Settings settings) {
        super(settings);
    }

package cam11062.strange.berries.util;
    ...
    public static int addSicknessLevel(IEntityDataSaver player, int amount) {
        ...
        if (sicknesslevel + amount >= 3) {
            ...
            if (!playerentity.getAbilities().creativeMode) {
                ...
                ((PlayerEntity) player).sendMessage(Text.translatable(BERRY_SICKNESS_MESSAGE).fillStyle(Style.EMPTY.withColor(Formatting.RED)), true);
            }
            }
        else {
